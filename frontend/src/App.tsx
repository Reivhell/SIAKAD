...
const MahasiswaView = lazy(() => import('./components/views/MahasiswaView').then(m => ({ default: m.MahasiswaView })));
const KRSView = lazy(() => import('./components/views/KRSView').then(m => ({ default: m.KRSView })));
const KHSView = lazy(() => import('./components/views/KHSView').then(m => ({ default: m.KHSView })));
const PresensiView = lazy(() => import('./components/views/PresensiView').then(m => ({ default: m.PresensiView })));
const MahasiswaDashboardView = lazy(() => import('./components/views/MahasiswaDashboardView').then(m => ({ default: m.MahasiswaDashboardView })));
const AlumniDashboardView = lazy(() => import('./components/views/AlumniDashboardView').then(m => ({ default: m.AlumniDashboardView })));
const LecturerDashboardView = lazy(() => import('./components/views/LecturerDashboardView').then(m => ({ default: m.LecturerDashboardView })));
const AdminDashboardView = lazy(() => import('./components/views/AdminDashboardView').then(m => ({ default: m.AdminDashboardView })));
const KaprodiDashboardView = lazy(() => import('./components/views/KaprodiDashboardView').then(m => ({ default: m.KaprodiDashboardView })));
const DekanDashboardView = lazy(() => import('./components/views/DekanDashboardView').then(m => ({ default: m.DekanDashboardView })));
    ...
    return (
      <div className={darkMode ? 'dark' : ''}>
        {isPreloading && tempUserData ? (
          ...
          <Suspense fallback={<SkeletonLoader darkMode={darkMode} />}>
    ...
    <AnimatePresence mode="wait">
      {isSkeletonLoading ? (
        ...
        >
          ...
          <div id="desktop-sidebar-container" className="hidden lg:block w-64 shrink-0">
            <Sidebar 
              currentView={currentView} 
