...
import { fetchAcademicCourses, fetchAcademicAnnouncements, submitAbsenceForm, ApiCourse } from '../../utils/api';
...
export default function ShowcaseView() {
  ...
  const [selectedCaslRole, setSelectedCaslRole] = useState<string>(user?.role || 'student');
  ...
  const currentAbility = useMemo(() => defineRulesFor(selectedCaslRole as any), [selectedCaslRole]);
